...
const EditCharacterModal: React.FC<EditCharacterModalProps> = ({
  ...
  return isOpen ? (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        className="ui-fade-in fixed inset-0 backdrop-blur-sm"
        onClick={onClose}
      />
      <div
        className="ui-dialog-enter relative w-full max-w-4xl bg-[#1a1816] border border-[#534741] rounded-lg shadow-xl z-10 overflow-hidden"
      >
